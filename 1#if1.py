'''
    ...
    contraseña e imprima por pantalla si la contraeña introducida por el usuario coincide con la guardada en la
    variable sin tener en cuenta mayusculas y minusculas.
'''
